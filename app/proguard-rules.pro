...
-keep class  com.gaop.huthelper.model.entity.** {*;}
-keep class  com.gaop.huthelperdao.** {*;}
...
-keep public class com.gaop.huthelper.R$*{
    public static final int *;
}
...
-keep class com.github.jdsjlzx.recyclerview.** {*;}
