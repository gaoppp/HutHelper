package com.gaop.huthelper.widget.ninepictureview;
...
public abstract class PictureLayout extends ViewGroup {
    ...
    public PictureLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.PictureGridLayout);
        space = typedArray.getDimension(R.styleable.PictureGridLayout_sapce, DEFUALT_SPACE);
        typedArray.recycle();
        init(context);
    }
