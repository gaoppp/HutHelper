...
import com.gaop.huthelper.view.activity.SplashActivity;
...
public class CourseWidget extends AppWidgetProvider {
    ...
    private List<Lesson> lessonList = DBHelper.getLessonDao();

    private static int xqj = DateUtil.getWeekOfToday();

    public static final String TAG = "CourseWidgetProvider";

    public static final String COURSE_UP_ACTION = "com.gaop.HutHelper.action_courseup";

    public static final String COURSE_DOWN_ACTION = "com.gaop.HutHelper.action_coursedown";

    public static final String WEEK_PRE_ACTION = "com.gaop.HutHelper.action_weekprevious";

    public static final String WEEK_NEXT_ACTION = "com.gaop.HutHelper.action_weeknext";

    // public static final String START_COURSEACTIVITY_ACTION = "com.gaop.HutHelper.action_startcouActivity";

    //public static final String START_MAINACTIVITY_ACTION="com.gaop.HutHelper.action_startmainActivity";
    ...
    private void onWidgetUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        ...
        RemoteViews remoteViews = new RemoteViews(context.getPackageName(), R.layout.course_widget);
        remoteViews.setTextViewText(R.id.tv_widget_weeknum, "第" + DateUtil.getNowWeek() + "周");
    ...
    private void init(Context context, RemoteViews views) {
        ...
        if (size == 0) {
            ...
            Intent intent3 = new Intent(context, CourseTableActivity.class);
    ...
    private static class LessonComparator implements Comparator<Lesson> {
        ...
        public int compare(Lesson lhs, Lesson rhs) {
            Log.e(TAG, "compare: " + lhs.getDjj() + rhs.getDjj());
            Log.e(TAG, lhs.getDjj() - rhs.getDjj() + " ");
            return lhs.getDjj() - rhs.getDjj();
        }
    }
}
