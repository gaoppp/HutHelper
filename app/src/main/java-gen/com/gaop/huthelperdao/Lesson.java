...
public class Lesson implements java.io.Serializable {
    ...
    private String dsz;//单双周
    private String name;//课程名
    private String teacher;//教师
    private String room;//教室
    private Integer xqj;//星期几
    private Integer djj;//第几节
    private Integer qsz;//起始周
    private Integer jsz;//结束周
    private String index;//索引  1 2 4 5....
    private Boolean addbyuser;//是否用户自己添加
    ...
    public Lesson(Long id, String xh, String dsz, String name, String teacher, String room, Integer xqj, Integer djj, Integer qsz, Integer jsz, String index, Boolean addbyuser) {
        this.id = id;
        this.xh = xh;
        this.dsz = dsz;
        this.name = name;
